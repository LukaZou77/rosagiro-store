...
export const siteConfig = {
  ...
  productConversion: {
    ...
    wholesaleInfoTitle: "Informacoes para atacado",
    wholesaleInfoNote: "Os dados ajudam a montar lista de reposicao. Para volume maior, confirme estoque, validade/lote e entrega pelo WhatsApp.",
