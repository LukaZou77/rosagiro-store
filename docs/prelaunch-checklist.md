...
6. 物流规则确认：在 `/admin/frete` 确认 Melhor Envio 正式令牌、发货 CEP、商品重量和技术包装参数，并人工确认保险、税费、风险区、Retirada、Transportadora 和 Excursão。
...
- Melhor Envio 第一版只做结账前运费报价，面单购买、保险、税费和风险区继续人工确认。
